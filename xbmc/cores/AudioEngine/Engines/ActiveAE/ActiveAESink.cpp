...
bool CActiveAESink::SupportsFormat(const std::string &device, CAEStreamInfo &steaminfo)
{
  std::string dev = device;
  std::string dri;

  // IEC packed
  unsigned int samplerate = steaminfo.m_sampleRate;
  AEDataFormat format;
  switch (steaminfo.m_type)
  {
