...
#define PLAYER_PROCESS_VIDEOHWDECODER (PLAYER_PROCESS + 6)
#define PLAYER_PROCESS_AUDIODECODER (PLAYER_PROCESS + 7)
#define PLAYER_PROCESS_AUDIOCHANNELS (PLAYER_PROCESS + 8)
#define PLAYER_PROCESS_AUDIOSAMPLERATE (PLAYER_PROCESS + 9)
#define PLAYER_PROCESS_AUDIOBITSPERSAMPLE (PLAYER_PROCESS + 10)
